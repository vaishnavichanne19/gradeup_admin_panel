...
export const BoardSubject: React.FC = () => {
...
}, [subjects, classes, boards, searchQuery]);
  ...
  return (
    <div>
      <PageMeta
        ...
        description="This is the Board Subject page"
      />
      <PageBreadcrumb pageTitle="Board Subject" />
